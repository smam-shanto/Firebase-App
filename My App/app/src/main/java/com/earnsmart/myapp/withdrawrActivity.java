...
public class withdrawrActivity extends AppCompatActivity {
    Button withbtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_withdrawr);
                ...
                reference.child(username).setValue(withdraw).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            startActivity(new Intent(withdrawrActivity.this,withdrawActivity.class));
                        }
                    }
                });
            }
